...
___x___ , ___x___ , ___x___ , ___x___ ,
                                              _______ , _______ , ___fn__ ,___x___ , ___x___ , ___x___ ,   KC_BSLS , KC_0    , KC_EQ,___x___ , ___x___ , ___x___  L
  //                                         ---------+---------+---------  ---------+---------+---------
  ),
...
___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ , ___x___ ,
  ...
  // ---------+---------+---------+---------+---------+---------                      ---------+---------+---------+---------+---------+---------
___x___ , ___x___ , ___x___ , ___x___ ,
                                              ___fn__ , _______ , _______ ,___x___ , ___x___ , ___x___ ,   _______ , _______ , _______,___x___ , ___x___ , ___x___
  //                                         ---------+---------+---------  ---------+---------+---------
  ),
